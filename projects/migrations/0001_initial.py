    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Mis à jour le')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_devis', to=settings.AUTH_USER_MODEL, verbose_name='Créé par')),
            ],
            options={
                'verbose_name': 'Devis',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.product', verbose_name='Produit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surface_murs', models.DecimalField(blank=True, decimal_places=2, help_text='Surface des murs à peindre', max_digits=8, null=True, verbose_name='Surface murs (m²)')),
                ('surface_plafond', models.DecimalField(blank=True, decimal_places=2, help_text='Surface du plafond à peindre', max_digits=8, null=True, verbose_name='Surface plafond (m²)')),
                ('hauteur_sous_plafond', models.DecimalField(blank=True, decimal_places=2, help_text='Hauteur sous plafond en mètres', max_digits=4, null=True, verbose_name='Hauteur sous plafond (m)')),
                ('nombre_pieces', models.PositiveIntegerField(default=1, help_text='Nombre total de pièces concernées', verbose_name='Nombre de pièces')),
                ('types_pieces', models.JSONField(blank=True, default=list, help_text='Liste des types de pièces concernées', verbose_name='Types de pièces')),
                ...
                ('preparation_necessaire', models.TextField(blank=True, help_text='Travaux de préparation requis', verbose_name='Préparation nécessaire')),
                ...
                ('acces_difficile', models.BooleanField(default=False, help_text='Accès difficile ou contraintes particulières', verbose_name='Accès difficile')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to=settings.AUTH_USER_MODEL, verbose_name='Client')),
            ],
            options={
                'verbose_name': 'Projet',
        ...
        migrations.AddIndex(
            model_name='project',
            index=models.Index(fields=['type_projet', 'status'], name='projects_pr_type_pr_371ac0_idx'),
        ),
        migrations.AddIndex(
            model_name='project',
