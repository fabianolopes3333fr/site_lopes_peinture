    ...
    class Meta:
        ...
        widgets = {
            ...
            "ville": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Paris"}
            ),
        ...
        if surface_totale and surface_murs and surface_plafond:
            if (surface_murs + surface_plafond) > (surface_totale * 3):  # Tolerância
                self.add_error(
                    "surface_totale",
                    _(
                        "La surface totale semble incohérente avec les surfaces détaillées."
                    ),
                )
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Nom du produit"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-textarea",
...
class ProjectFilterForm(forms.Form):
    ...
    search = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-input", "placeholder": "Rechercher..."}
        ),
    )
